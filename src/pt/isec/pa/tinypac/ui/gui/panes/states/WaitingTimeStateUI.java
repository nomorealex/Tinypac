...
public class WaitingTimeStateUI extends Canvas {
     ...
     * */
    public WaitingTimeStateUI(TinyPacModelManager tinyPacModelManager) {
     ...
     * */
    private void update() {
        if (tinyPacModelManager.getFsmState() != TinyPacState.WAITINGTIME_STATE) {
            setVisible(false);
            return;
        }
        setVisible(true);
